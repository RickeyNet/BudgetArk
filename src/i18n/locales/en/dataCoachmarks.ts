/**
 * BudgetArk - English strings: bundled data (coachmarks)
 * File: src/i18n/locales/en/dataCoachmarks.ts
 *
 * Covers: coachmarkContent.ts tour intros + steps (title, body, detail,
 * location, keywords), keyed by tab id + step id. Resolved lazily from
 * src/data via src/i18n/translate.ts. `keywords` is a comma-separated list
 * of lowercase search-only synonyms (split at read time, never rendered).
 */

export const dataCoachmarks = {
  DebtTracker: {
    intro: "Debts - your payoff plan",
    steps: {
      "debts-summary": {
        title: "Your debt at a glance",
        body: "Total balance, total paid, and overall progress live here. The ring on the right tracks your % paid off across every debt, and the countdown below projects your debt-free date from your actual payment pace.",
      ...
      "debts-fab": {
        ...
        body: "Tap the + button to add a credit card, loan, or mortgage. You set the balance, APR, and minimum payment - payments you record reduce the balance.",
      ...
      "debts-payments": {
        ...
        body: "Tap a debt card to record a payment or open its payment history - every payment lowers the balance and counts toward your progress. Give a debt a due day and BudgetArk reminds you in-app when it's coming up, with a one-tap prompt to log the minimum on the day it's due.",
      ...
      "debts-keepalive": {
        ...
        body: "Banks can close a credit card that sits unused - and your credit score takes the hit. Turn on the keep-alive watch for any card and BudgetArk warns you before its inactivity window runs out.",
      ...
      "debts-strategy": {
        ...
        body: "Choose Avalanche (highest interest rate first), Snowball (smallest balance first), or keep your own custom order. Your strategy drives the payoff projections here and in the Charts tools.",
      ...
      "debts-milestones": {
        ...
        body: "Tap the milestones card to set targets for the 7 financial milestones - starter cushion, debt-free, emergency fund, retirement, and beyond.",
  ...
  Budget: {
    ...
    steps: {
      "budget-summary": {
        ...
        body: "Top card shows this month's income, expenses, and net. Use the < > arrows above it to look at past months - a full year of history is kept.",
      ...
      "budget-cashflow": {
        ...
        body: "At the start of each month, tell BudgetArk what's in your checking account. The Cash Flow card projects where the month ends - income in, planned bills and debt minimums out - and shows a live safe-to-spend number that updates as you log entries.",
      ...
      "budget-spending": {
        ...
        body: "The donut chart breaks down spending by category. Tap any category to see the entries inside or set a monthly limit.",
      ...
      "budget-fab": {
        ...
        body: "Income, expense, or savings entry. Mark anything that repeats as Recurring and it auto-fills every month. Income entries can be tagged as W-2 or 1099 paychecks, and any entry can be marked 🔒 Private so it never syncs to your partner's device.",
        detail: "Entries are the heart of the budget: type (income / expense), category, amount, date (pick the day it happened - it defaults to today, with a Today shortcut), and an optional description. Recurring entries fill themselves in every month until you stop them - perfect for rent, subscriptions, and paychecks. Income can be tagged W-2 (enter your take-home amount, optionally recording the 401(k) dollars withheld so retirement savings still get credit) or 1099 / contractor (nothing is withheld, so BudgetArk shows how much to set aside for taxes at a percentage you pick). Expenses can carry up to three encrypted receipt photos and a business tag. The 🔒 Private toggle keeps an entry off your paired partner's device entirely - for gifts, surprises, or spending that's simply yours - while it still counts in your own budget, backups, and exports (mark it private when you create it; a copy that already synced stays with your partner). Multi-line quick-add lets you enter several purchases in one visit. Bills that change month to month (electric, water, gas) work best as a recurring estimate plus the real charge: tap 'Log actual' on the bill's row, or pick the bill under 'Applies to bill' when adding the expense or approving it in the Review Inbox, and that month the actual replaces the estimate everywhere instead of stacking on top of it. Editing a bill shows what its last few actual charges averaged, with a one-tap update.",
        location: "Budget tab → + button",
        keywords: "add entry, income, expense, recurring, subscription, w-2, w2, 1099, paycheck, 401k, retirement, taxes, set aside, private, gift, hide, secret, bill, actual, utility, electric, water, estimate, applies to bill, log actual",
      },
      "budget-widget": {
        title: "Quick Entry from your home screen (Android)",
        body: "Add BudgetArk's widget from your launcher's widget picker and log an expense in one tap - hit a category and the Add Entry form opens with it already picked.",
      ...
      "budget-inbox": {
        ...
        body: "Connected a bank in Profile? New transactions wait in the tray icon at the top of this screen - nothing enters your budget until you approve it. Check 'Always do this' while approving or skipping to teach BudgetArk a merchant rule, and change any saved rule later via the Rules button.",
      ...
      "budget-receipts": {
        ...
        body: "Attach up to three receipt photos to any entry - they're encrypted and never leave this phone. Tag an expense to a business (set businesses up in Profile) and it gets a 💼 badge; a tax-time report with CSV and receipt export lives in Profile → Business Expenses.",
  ...
  Bridge: {
    ...
    steps: {
      "bridge-history": {
        ...
        body: "Net Worth = everything you own minus everything you owe. The big number rolls up debts, savings, retirement, investments, and tracked accounts. The chart below it plots Net Worth over time - snapshots save automatically when balances change.",
      ...
      "bridge-accounts": {
        ...
        body: "Add savings, retirement, brokerage, or any account you want counted toward Net Worth. Tap a row to update its balance any time - the changes flow back into the Bridge view. Accounts linked to a bank connection keep their balances current automatically after every sync.",
      ...
      "bridge-changes": {
        ...
        body: "Every account row and category header shows how much it's up or down - use the 1D / 7D / 30D / 90D switch to change the window. The history behind it is recorded privately on this phone as you use the app, so the numbers appear from your second day on.",
      ...
      "bridge-plans": {
        ...
        body: "Sinking funds you start with the Charts tab's Plan a Purchase tool are tracked here: a progress bar per plan, the monthly pace a target date needs, and tap-to-add funds. Saved money counts toward your net worth, and a funded plan tells you it's ready to buy.",
  ...
  Utilities: {
    ...
    steps: {
      ...
      "charts-what-if": {
        ...
        body: "Pick one of your spending categories and see two futures side by side: how much sooner you'd be debt-free (and the interest you'd skip), or what that money would grow into after 1, 5, and 10 years. Computed from your own budget history, entirely on this phone.",
  ...
  Profile: {
    ...
    steps: {
      "profile-appearance": {
        ...
        body: "Pick a theme palette, a design style, and a density preset (Compact, Comfortable, Spacious) - density resizes padding and font sizes app-wide, and ambient themes bring a living background. Your display currency is set here too.",
      ...
      "profile-connections": {
        ...
        body: "Link your bank, cards, or brokerage using accounts YOU own - via SimpleFIN Bridge or Teller - and let transactions and balances import themselves. A built-in setup guide walks you through cost, sign-up, and privacy for each provider. Credentials stay encrypted on this device; BudgetArk has no server.",
        detail: "Bank syncing is bring-your-own: you connect through SimpleFIN Bridge (one pasted token, covers thousands of US banks, ~$1.50/month paid to them directly) or Teller (free tier via your own developer account) - BudgetArk operates no aggregator and never sits between you and your bank. A built-in guide walks through each provider's cost, sign-up, and privacy before you start. Imported transactions wait in the Budget tab's Review Inbox; mapped accounts keep Bridge balances current; a linked credit card can feed the keep-alive watch. Credentials are encrypted on this device only - they never sync to a partner, never ride backups, and never touch a server, because there isn't one.",
      ...
      "profile-sync-data": {
        ...
        body: "Pair with a partner's phone and sync over your home Wi-Fi - device to device, no cloud involved. The Data card handles encrypted backups, spreadsheet export/import, and Reset All Data (which starts you over at the first-launch setup).",
      ...
      "profile-extras": {
        ...
        body: "The Ship's Log tracks achievements as you use the app. You can also add custom budget categories, manage businesses for expense reports, turn on gentle tracking reminders, flip on privacy mode to block screenshots, lock the app behind a PIN, and leave an optional tip if BudgetArk has helped you.",
      ...
      "profile-help": {
        ...
        body: "Open Onboarding under Help any time - it's this whole guide in one searchable place, plus a Redo onboarding button that reruns the full first-launch flow. Your data is always kept.",
