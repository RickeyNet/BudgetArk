...
export const bridgeReports: LocalizedPlural<typeof en> = {
  ...
  history: {
    ...
    footer: "Щоденні знімки. Історія починається зараз. Проведи пальцем по лінії, щоб побачити значення за день.",
    chartA11y: "Графік чистих активів. Проведи по ньому, щоб дізнатися чисті активи за день.",
  },
  cashFlowChart: {
