...
export const CONNECTIONS_DISCLOSURE_POINTS: readonly string[] = [
  "Your credentials (a SimpleFIN token, your own Schwab app key and secret, or your Teller certificate) are stored encrypted on this device only. They never sync to a paired partner and never touch a BudgetArk server - BudgetArk doesn't have one.",
  "To fetch balances and transactions, this device connects directly to SimpleFIN, Schwab, or Teller. Those providers see the requests come from you, not from BudgetArk.",
