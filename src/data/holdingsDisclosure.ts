...
export const HOLDINGS_DISCLOSURE_POINTS: readonly string[] = [
  ...
  "To show prices, only your ticker symbols are sent to BudgetArk's quote service about once a week. Your share counts, balances, and identity are never sent.",
