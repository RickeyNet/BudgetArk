...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      "Changing your currency can now convert your existing amounts. When you switch to a currency that uses a different unit, BudgetArk asks whether to convert all your figures - debts, payments, budget, savings, net worth, and milestone targets - to the new currency at the current rate, or simply change the symbol and keep the same numbers. Converting uses a fixed reference rate, so it's an approximate one-time switch, not a live exchange feed.",
