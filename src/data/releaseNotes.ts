...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      "Note: connecting via Teller, the Tip Jar, Tracking Reminders, and the Quick Entry widget require this update to be installed from the app store (they add new components); SimpleFIN works right away.",
    ],
  },
  {
    version: "1.8.3",
