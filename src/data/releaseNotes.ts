...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      "Onboarding and the walkthrough are now one flow: finishing setup leads straight into a guided tour that walks you tab by tab through the whole app. The tour - and the 'How to use BudgetArk' guide in Profile → Help - now covers everything: logging debt payments and payoff strategies, the Review Inbox for bank imports, receipts and business expenses, W-2/1099 paychecks, account rise/drop tracking, the Captain's Course, and every Charts tool.",
