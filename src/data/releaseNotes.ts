...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      "Two ways to connect. SimpleFIN Bridge covers Chase and thousands of US banks and cards with one pasted setup token (a small paid service, about $1.50/month, that you sign up for yourself). Teller offers 100 free bank connections through your own free teller.io developer account.",
