...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      "And four MORE themes round out the fleet. Lighthouse is a true accessibility theme: near-black with a beam-yellow accent, and every single color verified at the strictest readability standard (WCAG AAA) - when the fog rolls in, follow the light. Chart Room turns the app into a vintage nautical map - aged paper, contour-line teal ink, brass fittings. Harbor Dawn is a soft light theme, pale peach into seafoam for people who find dark finance apps gloomy. And Ledger is for the budget nerds: cream paper and classic accounting green, like the books your grandfather kept.",
