...
// Slow CI runners take a few seconds per 250k-iteration PBKDF2 pass.
...
describe("encryptExportEnvelopeV3 / decryptExportEnvelopeV3", () => {
...
describe("golden v3 fixture (format pin)", () => {
  ...
  it("decrypts the pinned fixture (same golden payload as the v1/v2 fixtures)", async () => {
